...
public class AppiumSetup
{
	...
	public void RunBeforeAnyTests()
	{
		...
		var androidOptions = new AppiumOptions
		{
			...
			// App = Path.Join(TestContext.CurrentContext.TestDirectory, "../../../../MauiApp/bin/Release/net8.0-android/com.companyname.mobilecounter-Signed.apk"),
        ...
        androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.uplift.mobilecounter");

        //Make sure to set [Register("com.companyname.mobilecounter.MainActivity")] on the MainActivity of your android application
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.uplift.mobilecounter.MainActivity");
        ...
        androidOptions.AddAdditionalAppiumOption("avd", "Pixel_4a_API_33");
